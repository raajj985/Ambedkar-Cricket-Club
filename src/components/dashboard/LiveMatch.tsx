...
const LiveMatch: React.FC = () => {
  ...
  return (
    <Card className="col-span-1 lg:col-span-2">
      <CardHeader className="bg-cricket-primary text-white">
      ...
      <CardContent className="p-0">
        <div className="p-4 bg-cricket-pitch bg-opacity-30 border-b">
          <div className="flex items-center justify-between">
        ...
        <div className="p-4">
          <div className="flex justify-between border-b pb-2 mb-3 text-sm font-medium">
            <div>Batsman</div>
            ...
            return (
              <div key={batsman.playerId} className="flex justify-between py-2 text-sm">
                <div className="flex items-center">
                  <div className={`w-2 h-2 rounded-full mr-2 ${activeBatsmen[0] === batsman ? 'bg-cricket-primary' : 'bg-gray-300'}`} />
